...
const Search/*: NextPage<{}>*/ = () => {
    ...
    const tag/* : tagType[]*/ = [
                ...
                {title: "인물", list:["고인물", "기사", "남매", "네크로맨서", "누나", "능력", "능력자", "능력자배틀", "드래곤", "마녀", "마법", "미법사", "마법소녀", "마왕", "마피아", "매니저", "먼치킨", "메이드", "몬무스", "문제아", "미소녀", "배우", "병약", "빌런", "상태창", "서큐버스", "성장형", "성좌", "소꿉친구", "소환", "수인", "스트리머", "시한부", "아이돌", "악당", "악마", "악역", "악역영애", "얀데레", "엘프", "여동생", "여주", "용병", "용사", "이능", "이능력", "이종족", "정령", "치원이동", "천재", "초능력", "헌터", "흡혈귀", "히어로"]},
